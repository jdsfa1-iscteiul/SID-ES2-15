 ...
 * @version $Id: LoginDialog.java 37 2009-07-09 17:26:41Z tomas.varaneckas $
 * @since 0.1
 */
public class CredentialTesting {
     ...
     */
    private static CredentialTesting instance = null;
     ...
     */
    public static final CredentialTesting getInstance() {
        synchronized (CredentialTesting.class) {
            if (instance == null) {
                instance = new CredentialTesting();
            }
        }
        return instance;
    }
     ...
     * Logger
     */
    public static final Log log = LogFactory.getLog(CredentialTesting.class);
     ...
     */
    public Credentials show(final String prompt, GmailAccount account) {
        createDialog(prompt, account);
...
//    }
     ...
     */
    private void createDialog(final String prompt, GmailAccount account) {
